<template>
  <form class="mt-10 space-y-4" autocomplete="on">
    <div class="h-16 relative">
      ...
      <svg   class="w-6 absolute rtl:right-4 left-4 top-0 bottom-0 my-auto" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M17 16.0002L13 12.0002V8.82023C14.35 8.33023 15.26 6.93023 14.93 5.36023C14.68 4.18023 13.7 3.24023 12.51 3.04023C10.63 2.73023 9 4.17023 9 6.00023C9 7.30023 9.84 8.40023 11 8.82023V12.0002L7 16.0002H4C3.45 16.0002 3 16.4502 3 17.0002V20.0002C3 20.5502 3.45 21.0002 4 21.0002H7C7.55 21.0002 8 20.5502 8 20.0002V17.9502L12 13.7502L16 17.9502V20.0002C16 20.5502 16.45 21.0002 17 21.0002H20C20.55 21.0002 21 20.5502 21 20.0002V17.0002C21 16.4502 20.55 16.0002 20 16.0002H17Z" fill="#514037"/>
</svg>
    ...
    <div class="h-16 relative">
      <svg  class="w-6 absolute rtl:right-4 left-4 top-0 bottom-0 my-auto" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M12 12C14.21 12 16 10.21 16 8C16 5.79 14.21 4 12 4C9.79 4 8 5.79 8 8C8 10.21 9.79 12 12 12ZM12 14C9.33 14 4 15.34 4 18V19C4 19.55 4.45 20 5 20H19C19.55 20 20 19.55 20 19V18C20 15.34 14.67 14 12 14Z" fill="#514037"/>
</svg>
      <input
        id="username"
        class="border-[#E1E2E4] hover:border-[#8CB8FB] h-full px-[3.25rem] w-full text-[#1C0E07] text-lg focus:outline-none bg-transparent placeholder:text-[#A69F9B] pt-1 border-[0.125rem] focus:border-[#307FF8] rounded-[1rem]"
...
<path d="M12 4C7 4 2.73 7.11 1 11.5C2.73 15.89 7 19 12 19C17 19 21.27 15.89 23 11.5C21.27 7.11 17 4 12 4ZM12 16.5C9.24 16.5 7 14.26 7 11.5C7 8.74 9.24 6.5 12 6.5C14.76 6.5 17 8.74 17 11.5C17 14.26 14.76 16.5 12 16.5ZM12 8.5C10.34 8.5 9 9.84 9 11.5C9 13.16 10.34 14.5 12 14.5C13.66 14.5 15 13.16 15 11.5C15 9.84 13.66 8.5 12 8.5Z" fill="#514037"/>
  ...
  <div
            class="flex items-center justify-center p-5 mt-4 rounded-[1rem] bg-[#307FF8] cursor-pointer gap-2 text-white"
          >
          ...
          <div class="mt-4 text-center text-[#A69F9B] leading-[1.75rem]">
            ...
            <span @click="emit('step', 1)" class="mx-2 text-[#307FF8] cursor-pointer">Register</span>
          </div>
</template>
